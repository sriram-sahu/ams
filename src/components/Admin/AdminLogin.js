  ...
  return (
    <div>
      <div className='admin-login-container'>
        ...
        {isDashboard && <Dashboard data={finalData} />}
        {isAssessment && <SendAssessments data={finalData} />}
        {isTestReports && <TestReports datat={finalData} />}
        {isStudentReports && <StudentReports datat={finalData} />}
      </div>
      <Footer />
    </div>
  );
